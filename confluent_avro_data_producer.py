...
kafka_config = {
    ...
    'sasl.username': '44BIGN24B3AITMUG',
    'sasl.password': 'BL2S7mjU5XGgCdRmuXCUEICDVOEgxN8UdPn9dBdANi5GkA2TOzZ8tnAsSh5GZwdI'
}

# Create a Schema Registry client
schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-p6o1m.eu-central-1.aws.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('YQOSIMSNGVTCEJQ6', 'CxpzA9Sq5eW3ifAQOT7s1dBhTJGqKwhxkynLuliGrUxgwUzofx90R6eUOXjGQuDK')
})
